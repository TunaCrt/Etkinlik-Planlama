...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
            <div class="app-brand demo m-3 ">
                <a href="{{route("panel.event.index")}}" class="app-brand-link">
            ...
            <ul class="menu-inner py-1">
                ...
                <!-- Cards -->
                <li class="menu-item">
                    <a href="{{route("panel.event.MyEvents")}}" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-collection"></i>
                        <div data-i18n="Basic">Etkinliklerim</div>
                    </a>
                </li>
                <!-- User interface -->
                    ...
                    <ul class="navbar-nav flex-row align-items-center ms-auto">
                        ...
                        <li class="nav-item navbar-dropdown dropdown-user dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a class="dropdown-item" href="#">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1">
                                                <span href=""  class="fw-semibold d-block">{{Auth::user()->name}}</span>
                                ...
                                <li>
                                    <a class="dropdown-item" href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                                        <i class="bx bx-user me-2"></i>
                                        <span href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')" class="align-middle">{{Auth::user()->name}}</span>
                                    </a>
